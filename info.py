...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1762656188').split()]
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🎟 TITTLE :  {title} \n✨ RATING : {rating} \n🎭 GENRE : {genres} \n📆 RELEASE : {year} \n🎙️LANGUAGE : {languages} \n \n ©️ UPLOAD BY: @DailyMvTamil")
